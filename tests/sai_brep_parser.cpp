...
namespace minitao {
  namespace test {
    ...
    parse(string const & fileName)
    {
      ...
      if (doc.Error())
	throw runtime_error("minitao::test::BRParser::parse(" + fileName
	...
	minitao::mapNodesToIDs(robot_->idToNodeMap_, robot_->rootNode_);
	...
	// FOUND TAG "type":
	  ...
	  default:
	    throw std::runtime_error("minitao::test::BRParser::exploreJointNode(): invalid <type> `"
	...
	// FOUND TAG "axis":
	  ...
	  default:
	    throw std::runtime_error("minitao::test::BRParser::exploreJointNode(): invalid <axis> `"
